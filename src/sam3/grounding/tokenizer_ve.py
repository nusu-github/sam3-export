...
# Host-side tokenizer ported from sam3/model/tokenizer_ve.py.
...
DEFAULT_BPE_PATH = (
    Path(__file__).resolve().parents[1] / "assets" / "bpe_simple_vocab_16e6.txt.gz"
)
...
def canonicalize_text(
    text: str, *, keep_punctuation_exact_string: str | None = None
) -> str:
...
def _load_bpe_merges(bpe_path: str | os.PathLike) -> list[str]:
    """Load BPE merge lines from a gzip-compressed vocab file."""
...
class SimpleTokenizer(object):
    def __init__(
        self,
        bpe_path: str | os.PathLike | None = None,
        ...
        merges = _load_bpe_merges(bpe_path)
