...
# Text tower ported from sam3/model/text_encoder_ve.py.
...
from ..vision.vitdet_ops import LayerScale
...
class ResidualAttentionBlock(nn.Module):
    def __init__(
        ...
        ls_init_value: float | int | None = None,
        act_layer: Callable[[], nn.Module] = nn.GELU,
        norm_layer: Callable[[int], nn.Module] = nn.LayerNorm,
    ):
        super().__init__()
        # Attention — nn.MultiheadAttention keeps official checkpoint keys
        ...
        # MLP — nn.Linear for c_fc / c_proj state_dict key parity with official.
    ...
    def attention(
        self,
        q_x: Float[Tensor, "b n d"],
        k_x: Float[Tensor, "b n_k d"] | None = None,
        v_x: Float[Tensor, "b n_v d"] | None = None,
        attn_mask: Bool[Tensor, "..."] | Float[Tensor, "..."] | None = None,
    ) -> Float[Tensor, "b n d"]:
...
def text_global_pool(
    x: Float[Tensor, "b n d"],
    text: Integer[Tensor, "b n"] | None = None,
...
class TextTransformer(nn.Module):
    ...
    def build_causal_mask(self) -> Float[Tensor, "n n"]:
    ...
    def forward(
        self, text: Integer[Tensor, "b n"]
    ) -> Float[Tensor, "..."] | tuple[Float[Tensor, "..."], Float[Tensor, "..."]]:
...
class VETextEncoder(nn.Module):
    def __init__(
        ...
        # nn.Linear keeps resizer.weight / resizer.bias keys matching official.
        self.resizer = nn.Linear(self.encoder.width, d_model)

    def forward(
        self,
        text: Sequence[str] | tuple[Tensor, Tensor, Mapping[str, Tensor]],
        input_boxes: Sequence | None = None,
        device: torch.device | str | None = None,
    ) -> tuple[
        Bool[Tensor, "b seq"] | Float[Tensor, "b seq"],
        Float[Tensor, "seq b d_model"],
        Float[Tensor, "seq b width"],
    ]:
